        ...
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                <a href="index.html" class="block mb-[25px]">
                    <img src="{{asset('frontend/assets/images/logo/logo.png')}}" width="99" height="46" loading=lazy alt="footer logo">
                </a>
            ...
            <div class="col-span-12 md:hidden sm:col-span-6 lg:col-span-2 mb-[30px]">
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    <li class="first:ml-0 ml-[15px]"><a href="https://www.facebook.com/" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                            <svg width="7" height="12" viewBox="0 0 7 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.36 4.20156V3.12156C4.36 2.65356 4.468 2.40156 5.224 2.40156H6.16V0.601562H4.72C2.92 0.601562 2.2 1.78956 2.2 3.12156V4.20156H0.760002V6.00156H2.2V11.4016H4.36V6.00156H5.944L6.16 4.20156H4.36Z" fill="currentColor"></path>
                ...
                <p class="text-sm md:hidden mt-[20px]">&copy; <a href="" class="text-secondary"></a> All Rights Reserved - Privacy Policy</p>
            </div>
        </div>
    </div>
</footer>
